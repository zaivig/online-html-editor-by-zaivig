...
function updateFooterText(lang) {
  ...
  if (lang === 'ru') {
    ...
    footerText.innerHTML = 'Сайт создан в рамках проекта <a href="https://smtl.ru/" target="_blank">МАОУ СМТЛ</a>.';
    footerContact.innerHTML = 'По вопросам и предложениям пишите на <a href="mailto:zaivig2011@gmail.com">zaivig2011@gmail.com</a>.';
    
  } else {
    footerText.innerHTML = 'Zagorodnov Ivan 2025'
    footerText.innerHTML = 'Site created as part of the project <a href="https://smtl.ru/" target="_blank">MAOU SMTL</a>.';
    footerContact.innerHTML = 'For questions and suggestions, write to <a href="mailto:zaivig2011@gmail.com">email</a>.';
  }
}
